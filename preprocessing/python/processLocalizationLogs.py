...
print("\nExecution of processLocalizationLogs.py started at " + str(datetime.datetime.now()))

# Selecting files to process

records0  = glob.glob('/home/ardelalegre/google-drive/ODAS/logs0/SSL/*.log')
records1  = glob.glob('/home/ardelalegre/google-drive/ODAS/logs1/SSL/*.log')
records2  = glob.glob('/home/ardelalegre/google-drive/ODAS/logs2/SSL/*.log')
records3  = glob.glob('/home/ardelalegre/google-drive/ODAS/logs3/SSL/*.log')
...
for mic_number in range(len(records)):
    ...
    for log in records[mic_number]:
        ...
        path = log_string[:log_string.find('S/') + 2] + 'localization_dataframes/dataframes' + str(mic_number) + '/' #change when you switch computers
        #         print(path)
        #         print(day)
        #         print(hour)
