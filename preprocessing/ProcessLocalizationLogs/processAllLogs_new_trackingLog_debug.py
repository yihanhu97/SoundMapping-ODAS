...
records0 = ['/home/chaitanya/google-drive/ODAS (151a469c)/logs0/SST/Processed/cSST_2020-07-31_14:55:04_0.log']
records1 = []
records2 = []
records3 = []
...
for mic_number in range(len(records)):
    ...
    destination = "/home/chaitanya/Desktop"
...
#         print(log_string)
        ...
        path = log_string[:log_string.find(')/') + 2] + 'dataframes/dataframes' + str(mic_number) + '/'
#         print(path)
#         print(day)
#         print(hour)
